...
app.controller('MainCtrl', function($scope, $http) {
    ...
    for (i = 1; i < 8; i++) {
        console.log(loaded_json.responseJSON[i]['lon'])
        marker = new google.maps.Marker({
            //position: new google.maps.LatLng([i][1], locations[i][2]),
            position: new google.maps.LatLng(parseInt(loaded_json.responseJSON[i]['lon']), parseInt(loaded_json.responseJSON[i]['lat'])),
            map: vm.map
            //console.log(i)
        });
